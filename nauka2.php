    ...
    <body>
        <div class='container'>
            ...
            ?>
                ...
                <a href='nauka.php' style="text-decoration: none; color: black; font-size: 120%; text-align: center;">                  
                <p>

                <?php

                    $sql = "SELECT Angielski, Polski FROM czlowiek WHERE Odpowiedz=0 AND Kryterium='czlowiek' LIMIT 1";

                    $wynik = mysqli_query($polaczenie, $sql);

                    while($wiersz = mysqli_fetch_assoc($wynik)){

                        $ang = $wiersz['Angielski'];
                        $pl = $wiersz['Polski'];
